...
exclude_files=("Pods" "OCLintTest/notest")
...
then
nowReportType="-report-type html -o oclintReport.html"
else
...
if [[ ${reportType} =~ ${REPORT_PMD} ]] && [ ! -f ./oclintReport.html ]
then
echo "-----分析失败-----"
return -1
else
